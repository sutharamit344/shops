  ...
  return (
    <div className="bg-[#FAFAF8] text-[#1A1F36] min-h-screen">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .ref-section { border-top: 2px solid #FF6A00; padding-top: 10px; margin-bottom: 28px; }
        .ref-label { font-size: 10px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: #FF6A00; }
        .ref-title { font-size: 22px; font-weight: 800; color: #1A1F36; margin-top: 2px; letter-spacing: -0.02em; }
        .ref-code { font-family: 'JetBrains Mono', monospace; background: #1A1F36; color: #FF6A00; font-size: 11px; padding: 2px 8px; border-radius: 6px; display: inline-block; }
      `}} />
      ...
      <div className="bg-[#1A1F36] text-white px-8 py-10">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-2xl font-extrabold tracking-tight">Shop<span className="text-[#FF6A00]">Setu</span></span>
          </div>
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <span className="px-3 py-1.5 rounded-full bg-[#FF6A00]/20 border border-[#FF6A00]/30 text-[#FF6A00] text-xs font-semibold">v1.0</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-14 space-y-20">
          ...
          <div className="bg-white rounded-2xl border border-[#1A1F36]/[0.07] overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="flex items-baseline gap-3">
                <span className="text-2xl font-bold text-[#FF6A00] font-mono">₹380</span>
        ...
        <section>
          ...
          <div className="bg-white rounded-2xl border border-[#1A1F36]/[0.07] p-6">
            <div className="flex flex-wrap gap-4 items-center">
              <button className="inline-flex items-center gap-2 h-10 px-5 bg-[#FF6A00] text-white text-[13px] font-semibold rounded-xl transition-all active:scale-95">Primary Button</button>
              <button className="inline-flex items-center gap-2 h-10 px-5 border-2 border-[#FF6A00] text-[#FF6A00] text-[13px] font-semibold rounded-xl hover:bg-[#FF6A00] hover:text-white transition-all active:scale-95">Outline</button>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="group block bg-white rounded-2xl border border-[#1A1F36]/[0.07] hover:border-[#FF6A00]/30 hover:shadow-lg transition-all duration-300 overflow-hidden">
              <div className="h-0.5 bg-gradient-to-r from-[#FF6A00] to-transparent opacity-60"></div>
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1 rounded-full bg-[#FF6A00]/10 text-[#FF6A00] border border-[#FF6A00]/20">Kirana</span>
                </div>
            ...
            <div className="p-6 bg-[#1A1F36] rounded-2xl text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FF6A00]/10 rounded-full -translate-y-1/2 translate-x-1/4"></div>
        ...
        {/* AI RULES */}
        <section className="bg-[#FF6A00]/10 border border-[#FF6A00]/20 rounded-2xl p-8">
          <p className="text-[11px] font-bold text-[#FF6A00] uppercase tracking-widest mb-6">AI Agent Guidelines</p>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-3 text-[14px] font-medium text-[#1A1F36]/70">
              <p>✅ Use <span className="text-[#FF6A00] font-bold">#FF6A00</span> for all primary actions</p>
