  ...
  return (
    <div className="bg-[#F7F7F5] text-[#0A0A0F] min-h-screen selection:bg-[#FF6A00]/10 selection:text-[#FF6A00]">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 space-y-24 pb-32">
                ...
                <div className="grid grid-cols-3 gap-4">
                   {[
                     ...
                     <div key={c.label} className="space-y-2">
                        <div className="aspect-square rounded-lg shadow-sm border border-black/[0.05]" style={{ background: c.hex }} />
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <div className="space-y-6">
                ...
                <div className="p-8 bg-white rounded-2xl border border-black/[0.05] shadow-sm flex flex-wrap gap-4">
             ...
             <div className="space-y-6">
                ...
                <div className="p-8 bg-white rounded-2xl border border-black/[0.05] shadow-sm">
                   <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg bg-[#0A0A0F] flex items-center justify-center shadow-lg">
        ...
        {/* 4. DESIGN GOVERNANCE */}
        <section className="bg-[#0A0A0F] rounded-3xl p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-16">
             ...
             <div className="grid grid-cols-1 gap-6">
                {[
                  ...
                  <div key={i} className="flex gap-4 p-5 rounded-2xl bg-white/[0.03] border border-white/[0.05] hover:bg-white/[0.05] transition-colors group">
                     <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-white/40 group-hover:text-[#FF6A00] transition-colors">
                        <rule.icon size={18} />
                     </div>
                     <div>
