...
export async function seedTestShops(count = 50, onProgress) {
  ...
  for (let i = 1; i <= total; i++) {
    ...
    const shopData = {
      ...
      shopNo: `G-${100 + i}`,
      zone: "Main Road",
      building: "Local Complex",
      village: "",
      pincode: "380001",
      phone: `98765${String(i).padStart(5, '0')}`,
      whatsapp: `98765${String(i).padStart(5, '0')}`,
      description: DESCRIPTIONS[Math.floor(Math.random() * DESCRIPTIONS.length)] + " Welcome to your one-stop solution for all needs.",
      status: "approved",
      ...
      coverImage: `https://images.unsplash.com/photo-${1555396273 + i}-367ea4eb4db5?w=800&auto=format&fit=crop`,
