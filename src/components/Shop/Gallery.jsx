      ...
      <div className="grid grid-cols-4 md:grid-cols-6 gap-2 px-1">
        {images.map?.((image, i) => (
          <div
            ...
            className="relative rounded-md overflow-hidden shadow-sm group cursor-pointer aspect-square border border-navy/5"
          >
            <img
              src={image}
        ...
        >
          ...
          <div className="max-w-5xl max-h-[85vh] w-full flex items-center justify-center">
            <img
              ...
              className="max-w-full max-h-full object-contain rounded-md shadow-2xl scale-in-center"
