...
export const ShopCardSkeleton = ({ variant = "grid" }) => {
  if (variant === "list") {
    return (
      <div className="bg-white rounded-md border border-black/[0.06] p-3.5 flex items-center gap-3.5 overflow-hidden relative">
        <div className="absolute inset-0 animate-shimmer" />
        <div className="w-12 h-12 rounded-md bg-black/[0.05] flex-shrink-0" />
  ...
  return (
    <div className="bg-white rounded-md border border-black/[0.06] overflow-hidden flex flex-col relative">
      <div className="absolute inset-0 animate-shimmer" />
      {/* Accent stripe */}
      ...
      <div className="p-4 flex flex-col flex-1 gap-3">
        ...
        <div className="flex items-start justify-between">
          <div className="w-10 h-10 rounded-md bg-black/[0.06]" />
        ...
        <div className="pt-3 border-t border-black/[0.04] flex items-center justify-between mt-auto">
          ...
          <div className="flex gap-1">
            <div className="w-7 h-7 rounded-md bg-black/[0.04]" />
            <div className="w-7 h-7 rounded-md bg-black/[0.04]" />
          </div>
        </div>
      </div>
