  ...
  return (
    <div className="bg-cream min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        {/* About Skeleton */}
        <div className="bg-white rounded-md p-6 shadow-sm border border-cream space-y-4 animate-pulse">
          <div className="flex gap-2">
        ...
        <div className="space-y-3">
          <div className="h-6 w-40 bg-gray-200 rounded-md mb-4 ml-1 animate-pulse"></div>
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white rounded-md p-5 shadow-sm border border-cream flex justify-between animate-pulse">
