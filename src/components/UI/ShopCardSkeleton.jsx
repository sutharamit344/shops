...
const ShopCardSkeleton = ({ variant = "grid" }) => {
  if (variant === "list") {
    return (
      <div className="bg-white rounded-md p-4 flex items-center gap-4 animate-pulse border border-black/[0.04]">
        ...
        <div className="w-9 h-9 bg-gray-50 rounded-md"></div>
      </div>
    );
  }

  return (
    <div className="bg-white rounded-md overflow-hidden animate-pulse border border-black/[0.04] h-full flex flex-col">
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="pt-4 border-t border-black/[0.04] mt-4 flex justify-between items-center">
          ...
          <div className="flex gap-1.5">
            <div className="w-8 h-8 bg-gray-50 rounded-md"></div>
            <div className="w-8 h-8 bg-gray-50 rounded-md"></div>
          </div>
        </div>
      </div>
